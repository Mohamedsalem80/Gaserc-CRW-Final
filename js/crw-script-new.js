...
function ButtonToNeutraliseAnomalies_Click() {
    ...
    for (let thiscolumn = 0; thiscolumn < Nrcols; thiscolumn++) {
        ...
        console.log("SumOfColumn = " + SumOfColumn);
        ...
        for (let thisrow = 0; thisrow < NrRows; thisrow++) {
            ...
            let ItsShareOfAnomaly = Math.round(AnomaliesEachYear[thiscolumn] * (XCell / SumOfColumn));
            console.log("ItsShareOfAnomaly = " + ItsShareOfAnomaly);
            Tempo[thisrow] = XCell - ItsShareOfAnomaly;
            console.log(`Tempo[${thisrow}] = ${Tempo[thisrow]}`);
        }
